...
// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=43c23a7c&shadow
  ...
  methods: {
    initialiseLazyLoad() {
      return new Promise((resolve, reject) => {
        resolve(this.infiniteId ? this.containerId = this.infiniteId : this.containerId = btoa(new Date().getTime() + Math.random()));
      });
    },
    ...
    setLazyLoad() {
      ...
      this.scrollParent.addEventListener("scroll", () => {
        if (this.scrollParent.scrollTop + this.scrollParent.clientHeight >= this.scrollParent.scrollHeight) {
          this.$emit("triggered");
        }
      });
    }
...
window.customElements.define('load-me-lazy', vue_wc_wrapper(external_Vue_default.a, Appshadow))
...
/******/ });
//# sourceMappingURL=load-me-lazy.js.map